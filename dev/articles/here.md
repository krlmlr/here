...
#> - Current working directory: /tmp/RtmpgeWWrQ
...
uuid::UUIDgenerate()
#> [1] "f2d2cf56-6499-4f26-95d0-69d013a1fcc2"
```
...
#> /tmp/RtmpgeWWrQ/file26751cab632a
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpgeWWrQ/file26751cab632a
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
