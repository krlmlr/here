...
#> - Current working directory: /tmp/RtmpRW8m6d
...
uuid::UUIDgenerate()
#> [1] "d403b307-4dbc-49da-821c-309693d44332"
```
...
#> /tmp/RtmpRW8m6d/file26272ade3f1
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpRW8m6d/file26272ade3f1
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
