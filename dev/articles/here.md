...
#> - Current working directory: /tmp/RtmpRVr6su
...
uuid::UUIDgenerate()
#> [1] "3cfb79f4-6774-4e89-bdee-b589824025a0"
```
...
#> /tmp/RtmpRVr6su/file26671f834bec
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpRVr6su/file26671f834bec
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
