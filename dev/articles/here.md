...
#> - Current working directory: /tmp/RtmpPRovTJ
...
uuid::UUIDgenerate()
#> [1] "a5b1b734-4073-4840-884f-5735dbce01aa"
```
...
#> /tmp/RtmpPRovTJ/file25807babc90c
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpPRovTJ/file25807babc90c
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
