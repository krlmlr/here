...
#> - Current working directory: /tmp/Rtmpo7CaQX
...
uuid::UUIDgenerate()
#> [1] "5cabbea1-0a62-443f-ad89-5a8fd25a6b21"
```
...
#> /tmp/Rtmpo7CaQX/file25a336ff93cb
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmpo7CaQX/file25a336ff93cb
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
