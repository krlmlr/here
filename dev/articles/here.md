...
#> - Current working directory: /tmp/RtmpUwteai
...
uuid::UUIDgenerate()
#> [1] "2c5ad54a-c997-46b2-bc06-ee2d7bee3d01"
```
...
#> /tmp/RtmpUwteai/file28c522120d90
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpUwteai/file28c522120d90
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
