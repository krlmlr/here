...
#> - Current working directory: /tmp/RtmpVhs3jG
...
uuid::UUIDgenerate()
#> [1] "d0f1c39c-7de4-4add-9b72-f4adb5be6c2d"
```
...
#> /tmp/RtmpVhs3jG/file28c94472943b
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/RtmpVhs3jG/file28c94472943b
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
