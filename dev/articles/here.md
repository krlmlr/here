...
#> - Current working directory: /tmp/Rtmp5VukLe
...
uuid::UUIDgenerate()
#> [1] "c319b4eb-adbd-4211-bfda-df8a4dcdc989"
```
...
#> /tmp/Rtmp5VukLe/file25dd3765a8d6
#> └── scripts
#>     └── script.R
...
#> 
#> > here::i_am("scripts/script.R")
#> here() starts at /tmp/Rtmp5VukLe/file25dd3765a8d6
#> 
#> > print("Hello, world!")
#> [1] "Hello, world!"
```
